...
#SBATCH --job-name=saige_1e-12_sim2
#SBATCH --output=rep%a_1e-12_sim2.out
#SBATCH --array=1-20
#SBATCH --mem=150G
...
while :; do
    ...
    if [ "$ITER" -eq 0 ]; then
        ...
        time plink --bfile ../../30G_6000n_500000m_controls_bias \
          --exclude platform_snps_phase1.txt \
          --keep-allele-order --make-bed --out 30G_6000n_500000m_controls_$next_suffix
        ...
        time plink --bfile 30G_6000n_500000m_controls_$suffix \
...
time plink --bfile ../../30G_6000n_500000m_controls_bias \
  ...
  --keep-allele-order --make-bed --out 30G_6000n_500000m_controls_phase2
#
# saige
...
#
    ...
    if [ "$ITER" -eq 0 ]; then
        echo 'iter 0'
        time plink --bfile 30G_6000n_500000m_controls_phase2 \
        --exclude platform_sig_snps_remove_phase3_iter0.txt \
        --keep-allele-order --make-bed --out 30G_6000n_500000m_controls_phase3_0
    else
        echo 'iter $ITER'
        time plink --bfile 30G_6000n_500000m_controls_phase3_$prev_suffix \
        --exclude platform_sig_snps_remove_phase3_iter$suffix.txt \
        --keep-allele-order --make-bed --out 30G_6000n_500000m_controls_phase3_$suffix
    fi
...
# remove itermediate files
#rm 30G_6000n_500000m_controls_*
